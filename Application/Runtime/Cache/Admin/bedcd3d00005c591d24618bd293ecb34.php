<?php if (!defined('THINK_PATH')) exit();?><h2 class="contentTitle">设置影片类别</h2>
<form method="post" action="/LanceLot/admin.php/Movie/setTypeHandle/navTabId/listmovie/callbackType/closeCurrent" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
