...
<script type="text/javascript">
	$(function(){
		$("#mpic .imglist a").click(function(){
			var pid = $(this).attr('mid'); //photo_id

			$.ajax({
				url : "http://localhost:8080/LanceLot/admin.php/Movie/deleteimg",
				detaType : "text",
				type : "post",
				data : { id : pid },
...
<div class="pageContent">
	<form method="post" action="/LanceLot/admin.php/Movie/navTabId/listmovie/callbackType/closeCurrent" class="pageForm required-validate" onsubmit="return iframeCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<div id="mpic">
				<?php if(is_array($pic)): foreach($pic as $key=>$vo): ?><div class="imglist" id="mpic<?php echo ($vo["id"]); ?>">
