<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="/LanceLot/admin.php/Acomment/index" method="post">
			...
			<tr>
				...
				<td>&nbsp; 状态：
					<select name="status" >
						...
						<?php if($_REQUEST['status']== 2): ?><option value="2" selected>举报</option>
						<?php else: ?>
						<option value="2">举报</option><?php endif; ?>
						<?php if($_REQUEST['status']== 3): ?><option value="3" selected>禁言</option>
						<?php else: ?>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="delete" href="/LanceLot/admin.php/Acomment/delete/id/<?php echo (C("TMPL_L_DELIM")); ?>item_id<?php echo (C("TMPL_R_DELIM")); ?>/navTabId/listsreview" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li class="line">line</li>
			<li><a class="edit" href="/LanceLot/admin.php/Acomment/edit/id/<?php echo (C("TMPL_L_DELIM")); ?>item_id<?php echo (C("TMPL_R_DELIM")); ?>"  width="600" height="350" target="dialog"><span>修改状态</span></a></li>
			<li class="line">line</li>
	...
	<table class="table" width="100%" layoutH="112">
		<thead>
			<tr>
				...
				<th width="40">演员</th>
				<th width="40">发表用户</th>
				<?php if($_REQUEST['_order']== 'unum'): ?><th width="40" orderField="unum" class="<?php echo ($_REQUEST['_sort']); ?>">有用数</th>
				<?php else: ?>
				<th width="40" orderField="unum">有用数</th><?php endif; ?>
		...
		<tbody>
			<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr target="item_id" rel="<?php echo ($v["id"]); ?>">
				...
				<td style="color:red;"><?php echo ($v["report"]); ?></td>
				...
				<td><a style="color:green;"href="/LanceLot/admin.php/Acomment/content/id/<?php echo ($v["id"]); ?>" target="dialog">查看回复内容</a></td>
