...
<head>
    ...
    <script type="text/javascript" src="/LanceLot/Public/dwz/js/speedup.js"></script>
    <script type="text/javascript" src="/LanceLot/Public/dwz/js/jquery-1.8.2.min.js"></script>
    <script type="text/javascript" src="/LanceLot/Public/dwz/js/jquery.cookie.js"></script>
    <script type="text/javascript" src="/LanceLot/Public/dwz/js/jquery.validate.js"></script>
    <script type="text/javascript" src="/LanceLot/Public/dwz/js/jquery.bgiframe.js"></script>

    <script type="text/javascript" src="/LanceLot/Public/dwz/xheditor-1.1.12-zh-cn.min.js"></script>
    <script type="text/javascript" src="/LanceLot/Public/dwz/uploadify/scripts/swfobject.js"></script>
    <script type="text/javascript" src="/LanceLot/Public/dwz/uploadify/scripts/jquery.uploadify.v2.1.0.js"></script>

    <script type="text/javascript" src="/LanceLot/Public/dwz/js/dwz.min.js"></script>
    <script type="text/javascript" src="/LanceLot/Public/dwz/js/dwz.regional.zh.js"></script>
        ...
        $(function(){
            DWZ.init("/LanceLot/Public/dwz/dwz.frag.xml",{
                ...
                callback:function(){
                    initEnv();
                    $("#themeList").theme({
                        themeBase:"/LanceLot/Public/dwz/themes"
                    });//相对于index，页面的主题的路径
                }
            });
        });
                ...
                <div class="accordion" fillSpace="sidebar">
                    ...
                    <div class="accordionContent">
                        <ul class="tree treeFolder">
                            <li><span>影片管理</span>
                                <ul>
                                    <li><a href="/LanceLot/admin.php/Movie/index" target="nvaTab" rel="listmovie" title="浏览影片信息">浏览影片信息</a></li>
